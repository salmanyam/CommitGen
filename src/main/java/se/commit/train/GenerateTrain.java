        ...
        try(Repository repository = JGitWrapper.openGitRepository(repoName)) {
            ...
            try {
                ...
                try (BufferedWriter bw = new BufferedWriter(fw)) {
                    for (int revNo = 2; revNo < 20/*commitData.size()*/; revNo++) {
                        ...
                        if (!isDiscardCommit(diffs)) {
                            ...
                            bw.write(NLG.generateChangeSentence(insertedItems, "added"));
                            bw.write(NLG.generateChangeSentence(updatedItems, "updated"));
                            bw.write(NLG.generateChangeSentence(deletedItems, "deleted"));
